  ...
  <div class="content-container">
    ...
    <div class="columns">
      ...
      <div class="column is-4" v-if="selectedHero">
        <div class="card">
          <header class="card-header">
            <p class="card-header-title">{{ selectedHero.fullName }}</p>
          </header>
...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter: 1,
    originDate: format(new Date(1998, 9, 2), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(1998, 10, 2), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 3,
    originDate: format(new Date(1999, 9, 2), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 4,
    originDate: format(new Date(1997, 7, 3), inputDateFormat),
    ...
    watch: {
      'selectedHero.capeCounter': {
        ...
        handler(newValue, oldValue){
          console.log(`Whatcher evaluated. old=${oldValue}, new=${newValue}`);
